...
const App = () => {
  ...
  if(selectedItem.length==0)
  {
    alert("Please Select Awailable Seats.")
        ...
        fetch('http://192.168.1.130/goto/v1/booking_api.php', {
          method: 'POST',
          headers: {
  ...
  const map_Function = () => {
   var mobile= route.params.tpno;
   navigation.navigate('Destination' , {tpno: mobile})
...
const update = () => {
  ...
  fetch('http://192.168.1.130/goto/v1/update2_api.php', {
    method: 'POST',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
...
//---------------------------------------------------------
  ...
  return (
    ...
    <Text style={{fontSize: 13, color: "black",textAlign: 'center', marginBottom: 2}}>Select Vehicle</Text>
...
/>
          ...
          <TouchableOpacity style={styles.button} onPress={map_Function}>
  <Text style={styles.text}>Choose Destination</Text>
</TouchableOpacity>


<TouchableOpacity style={styles.button} onPress={submit}>
            <Text style={styles.text}>Book Seat</Text>
        </TouchableOpacity>
        </View>
